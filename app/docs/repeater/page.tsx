...
const REPEATER_ENV_SNIPPET = `// Get, set, and delete variables
  ...
  return (
    <div className="mt-10">
      ...
      <section className="mb-16">
        ...
        <div className="rounded-lg border border-border overflow-hidden mt-4 h-[120px]">
          <TextEditor
            value={REPEATER_ENV_SNIPPET}
